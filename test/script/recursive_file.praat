...
assert output$ =
... "script 1a" + newline$ + "script 1b"  + newline$ + "script 1c" +
... "script 2a" + newline$ + "script 2b"  + newline$ + "script 2c" +
... "script 3a" + newline$ + "script 3b"  + newline$ + "script 3c" +
... "script 4a" + newline$ + "script 4b"  + newline$ + "script 4c" +
... "script 4d" + newline$ + "script 4e"  + newline$ + "script 4f" +
... "script 3d" + newline$ + "script 3e"  + newline$ + "script 3f" +
... "script 2d" + newline$ + "script 2e"  + newline$ + "script 2f" +
... "script 1d" + newline$ + "script 1e"  + newline$ + "script 1f"
